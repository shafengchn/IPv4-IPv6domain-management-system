...
<head>
   ...
   <script src="<%=basePath%>js/FunctionJS.js"></script>
    ...
    <script type="text/javascript">
        ...
        /**初始化**/
        $(function () {
            AddTabMenu('MySpace', '/GLPT/LdapUserIndex.do?', '我的域名', '4963_home.png', 'false');
            $("#tabs_iframe_MySpace").css('margin-top', '0px').css('margin-left', '0px');
            AddTabMenu('DomainNameClaim', '/GLPT/DM/DomainNameClaim.do?', '域名认领', '4963_home.png', 'false');
            $("#tabs_iframe_DomainNameClaim").css('margin-top', '0px').css('margin-left', '0px');
            iframeresize();
            writeDateInfo();
            readyIndex();
            ...
            tabs_container.find('#tabs_MySpace').addClass('selected');
            top.document.getElementById("tabs_iframe_MySpace").style.display = 'block';
        });
    </script>
</head>
<body>
