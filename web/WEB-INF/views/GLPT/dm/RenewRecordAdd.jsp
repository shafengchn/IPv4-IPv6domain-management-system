...
<div region="center">
<form id="ff" action="/GLPT/DM/RenewRecordAddOK.do" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        ...
        <tr>
            <th>续订内容：</th>
            <td>
                <textarea id="RenewContent" class="txtArea" style="width: 250px" rows="3" type="text" maxlength="200"
                          name="RenewContent"></textarea>
            </td>
        </tr>
        <tr>
            <th>备注：</th>
...
<script type="text/javascript">
    var fun_submit = function () {
        var win = $.messager.progress({title: '请稍等...', msg: '续订中...'});
        var formData = $("#ff").serialize();
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/RenewRecordAddOK.do",
            processData: true,
            dataType: "json",
            data: formData,
