...
<div title="网站、系统信息(<font face='宋体' style='color:red;'>*</font>)" style="overflow:auto;">
    <form id="ff" action="/GLPT/DM/DomainNameClaimOK.do" method="post">
        ...
        <input name="GLDepartmentCode" type="hidden" id="GLDepartmentCode" />
        <input name="GLYMobile" type="hidden" id="GLYMobile" value="${teacher.mobile}"/>
        <input name="GLYPhone" type="hidden" id="GLYPhone" value="${teacher.phone}"/>
        <input name="GLYEmail" type="hidden" id="GLYEmail" value="${teacher.email}"/>
        <input type="hidden" name="GLYIdType" id="GLYIdType" value="${teacher.idTypeCode}"/>
        <input type="hidden" name="GLYIdNumber" id="GLYIdNumber" value="${teacher.idNumber}"/>
        <input type="hidden" name="GLYIdImgPath1" id="GLYIdImgPath1" value="${teacher.idImgPath1}"/>
        <input type="hidden" name="GLYIdImgPath2" id="GLYIdImgPath2" value="${teacher.idImgPath2}"/>
        <input type="hidden" name="GLYIdImgPath3" id="GLYIdImgPath3" value="${teacher.idImgPath3}"/>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        ...
        <tr>
            ...
            <td><input name="GLYIdNumber" type="text" id="tmp_GLYIdNumber" maxlength="50" class="txt"
                       style="width: 220px" value="${teacher.idNumber}"/></td>
        </tr>
        <tr>
            ...
            <td>
                <iframe id="iframe_fileUpload_GLYIdImgPath1" width="100%" height="150px"
                        frameborder="0"
                        <c:if test="${teacher.idImgPath1==null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        <c:if test="${teacher.idImgPath1!=null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&fileName=${teacher.idImgPath1}&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        scrolling="no"
        ...
        <tr>
            ...
            <td>
                <iframe id="iframe_fileUpload_GLYIdImgPath2" width="100%" height="150px"
                        frameborder="0"
                        <c:if test="${teacher.idImgPath2==null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        <c:if test="${teacher.idImgPath2!=null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&fileName=${teacher.idImgPath2}&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        scrolling="no"
        ...
        <tr>
            ...
            <td>
                <iframe id="iframe_fileUpload_GLYIdImgPath3" width="100%" height="150px"
                        frameborder="0"
                        <c:if test="${teacher.idImgPath3==null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        <c:if test="${teacher.idImgPath3!=null}">
                            src="/COMMON/fileUploadImgEx.do?filePath=dm_attrFile&fileName=${teacher.idImgPath3}&imgShow=true&imgHeight=100&imgWidth=100"
                        </c:if>
                        scrolling="no"
...
var CurrPage = 0;
    $(function () {
        $("#tmpGLDepartmentCode").combobox({
            ...
            onLoadSuccess: function (data) {
                if (data) {
                    $("#tmpGLDepartmentCode").combobox('setValue', data[0].Code);
                }
            }
        });
    ...
    var fun_ECPSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=ECP&CallType=Claim&IframeId=${IframeId}";
    ...
    var fun_ApprovalSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=Approval&CallType=Claim&IframeId=${IframeId}";
        top.openDialog(url, 'RemoteTeacherSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
    ...
    var fun_FZRSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=FZR&CallType=Claim&IframeId=${IframeId}";
        top.openDialog(url, 'TeahcerSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
