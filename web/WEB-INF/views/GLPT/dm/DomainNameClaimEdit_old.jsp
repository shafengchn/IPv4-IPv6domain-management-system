...
var CurrPage = 0;
    ...
    var fun_ApprovalSelect = function () {
        var url = "/GLPT/BASE/BorrowerSelect.do?CallModule=Approval&CallType=ClaimEdit&IframeId=${IframeId}";
    ...
    var fun_FZRSelect = function () {
        var url = "/GLPT/BASE/BorrowerSelect.do?CallModule=FZR&CallType=ClaimEdit&IframeId=${IframeId}";
        top.openDialog(url, 'BorrowerSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
