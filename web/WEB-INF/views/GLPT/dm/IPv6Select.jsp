...
<div region="south" style="text-align: center; padding-top: 5px; height: 40px;">
    <a id="Accept" class="l-btn" onclick="fun_SelectIPv6()" href="javascript:void(0)">
...
<script type="text/javascript">
    $(function () {
        $('#tt').datagrid({
            ...
            nowrap: false,
            striped: true,
            url: '/GLPT/DM/IPv6FindPage.do?Enabled=true',
            remoteSort: false,
            rownumbers: true,
            idField: 'Id',
            frozenColumns: [
    ...
    var fun_SelectIPv6=function(){
        ...
        if(row){
           ...
           if(GetQuery("CallType")=="Add"){
               top.DomainNameAdd.fun_SetIPv6(tmpStr1);
           }else{
               top.DomainNameEdit.fun_SetIPv6(tmpStr1);
           }
            OpenClose();
        }else{
