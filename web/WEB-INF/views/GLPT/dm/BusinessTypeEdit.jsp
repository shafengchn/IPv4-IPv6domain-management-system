...
<div region="center">
<form id="ff" action="/GLPT/DM/BusinessTypeEditOK.do" method="post">
    <input type="hidden" id="Id" name="Id" value="${bType.id}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>业务类型代码[<font face="宋体" color="red">*</font>]：</th>
            <td>
                <input name="Code" type="text" id="Code" maxlength="50" class="txt"
                       style="width: 220px" value="${bType.code}"/>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input name="FullName" type="text" id="FullName" maxlength="50" class="txt"
                       style="width: 220px" value="${bType.fullName}"/>
            </td>
        </tr>
        <tr>
            <th>排序号[<font face="宋体" color="red">*</font>]：</th>
            <td><input name="SortCode" type="text" id="SortCode" class="easyui-numberbox" min="0" style="width: 220px" value="${bType.sortCode}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea id="Remarks" class="txtArea" style="width: 220px" rows="6" type="text" maxlength="200"
                          name="Remarks">${bType.remarks}</textarea>
            </td>
        </tr>
    </table>
</form>
...
<script type="text/javascript">
    $(function(){
        $("#Enabled").attr("checked",${bType.enabled});
    });
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/BusinessTypeEditOK.do",
            processData: true,
            dataType: "json",
            data: formData,
