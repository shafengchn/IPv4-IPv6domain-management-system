...
<script type="text/javascript">
    ...
    var fun_ECPSelect = function () {
        var url = "/GLPT/BASE/BorrowerSelect.do?CallModule=ECP&CallType=Edit&IframeId=${IframeId}";
        top.openDialog(url, 'BorrowerSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
    ...
    var fun_ApprovalSelect = function () {
        var url = "/GLPT/BASE/BorrowerSelect.do?CallModule=Approval&CallType=Edit&IframeId=${IframeId}";
        top.openDialog(url, 'BorrowerSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
