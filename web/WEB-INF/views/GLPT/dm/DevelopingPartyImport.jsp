...
<html>
<head>
    <title>开发方资料-导入</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body class="easyui-layout">
<div region="center">
    <form id="ff" action="/GLPT/DM/DevelopingPartyImportOK.do" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                <td>开发方资料模板：</td>
                <td style="text-align: left;">
                    <a class="l-btn" href="/COMMON/DownloadDataTemplate.do?fileCode=DevelopingPartyImport&filePath=DataTemplate"
                       target="_blank">
        <span class="l-btn-left">
            ...
            <tr>
                <td colspan="2">
                    <iframe id="iframe_fileUpload_DevelopingPartyImport" width="100%" height="120px"
                            frameborder="0" src="/COMMON/fileUploadEx.do?filePath=other" scrolling="no"
                            name="iframe_fileUpload_DevelopingPartyImport"></iframe>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        var fileName1 = "";
        var iframe1 = document.getElementById("iframe_fileUpload_DevelopingPartyImport");
        if (iframe1 != null) {
            fileName1 = iframe1.contentWindow.fun_GetFileName();
        }
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/DevelopingPartyImportOK.do",
            processData: true,
            dataType: "json",
