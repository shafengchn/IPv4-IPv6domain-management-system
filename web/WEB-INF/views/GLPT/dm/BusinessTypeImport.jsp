...
<div region="center">
    <form id="ff" action="/GLPT/DM/BusinessTypeImportOK.do" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                <td>业务类型模板：</td>
                <td style="text-align: left;">
                    <a class="l-btn" href="/COMMON/DownloadDataTemplate.do?fileCode=BusinessTypeImport&filePath=DataTemplate"
                       target="_blank">
        <span class="l-btn-left">
            ...
            <tr>
                <td colspan="2">
                    <iframe id="iframe_fileUpload_BusinessTypeImport" width="100%" height="120px"
                            frameborder="0" src="/COMMON/fileUploadEx.do?filePath=other" scrolling="no"
                            name="iframe_fileUpload_BusinessTypeImport"></iframe>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        var fileName1 = "";
        var iframe1 = document.getElementById("iframe_fileUpload_BusinessTypeImport");
        if (iframe1 != null) {
            fileName1 = iframe1.contentWindow.fun_GetFileName();
        }
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/BusinessTypeImportOK.do",
            processData: true,
            dataType: "json",
