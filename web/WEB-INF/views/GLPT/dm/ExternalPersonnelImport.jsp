...
<html>
<head>
    <title>外聘人员资料-导入</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body class="easyui-layout">
<div region="center">
    <form id="ff" action="/GLPT/DM/ExternalPersonnelImportOK.do" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                <td>外聘人员资料模板：</td>
                <td style="text-align: left;">
                    <a class="l-btn" href="/COMMON/DownloadDataTemplate.do?fileCode=ExternalPersonnelImport&filePath=DataTemplate"
                       target="_blank">
        <span class="l-btn-left">
            ...
            <tr>
                <td colspan="2">
                    <iframe id="iframe_fileUpload_ExternalPersonnelImport" width="100%" height="120px"
                            frameborder="0" src="/COMMON/fileUploadEx.do?filePath=other" scrolling="no"
                            name="iframe_fileUpload_ExternalPersonnelImport"></iframe>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        var fileName1 = "";
        var iframe1 = document.getElementById("iframe_fileUpload_ExternalPersonnelImport");
        if (iframe1 != null) {
            fileName1 = iframe1.contentWindow.fun_GetFileName();
        }
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/ExternalPersonnelImportOK.do",
            processData: true,
            dataType: "json",
