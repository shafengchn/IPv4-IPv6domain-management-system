...
<script type="text/javascript">
    ...
    var fun_GLYSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=GLY&CallType=Add&IframeId=${IframeId}";
    ...
    var fun_ECPSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=ECP&CallType=Add&IframeId=${IframeId}";
        top.openDialog(url, 'RemoteTeacherSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
    ...
    var fun_ApprovalSelect = function () {
        var url = "/GLPT/RemoteBASE/RemoteTeacherSelect.do?CallModule=Approval&CallType=Add&IframeId=${IframeId}";
        top.openDialog(url, 'RemoteTeacherSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
    ...
    var fun_FZRSelect = function () {
        var url = "/GLPT/RemoteBASE/BorrowerSelect.do?CallModule=FZR&CallType=Add&IframeId=${IframeId}";
        top.openDialog(url, 'RemoteTeacherSelect', '选择学校教师资料', 600, 300, 50, 50);
    }
