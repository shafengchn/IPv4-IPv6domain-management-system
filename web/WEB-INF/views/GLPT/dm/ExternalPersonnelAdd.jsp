...
<form id="ff" action="/GLPT/DM/ExternalPersonnelAddOK.do" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        ...
        <tr>
            ...
            <td><input name="SortCode" type="text" id="SortCode" class="easyui-numberbox" min="0" style="width: 150px" value="${SortCode}"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/ExternalPersonnelAddOK.do",
            processData: true,
            dataType: "json",
            data: formData,
