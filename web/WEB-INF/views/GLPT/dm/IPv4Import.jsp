...
<div region="center">
    <form id="ff" action="/GLPT/DM/IPv4ImportOK.do" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                <td>IPv4模板：</td>
                <td style="text-align: left;">
                    <a class="l-btn" href="/COMMON/DownloadDataTemplate.do?fileCode=IPv4Import&filePath=DataTemplate"
                       target="_blank">
        <span class="l-btn-left">
            ...
            <tr>
                <td colspan="2">
                    <iframe id="iframe_fileUpload_IPv4Import" width="100%" height="120px"
                            frameborder="0" src="/COMMON/fileUploadEx.do?filePath=other" scrolling="no"
                            name="iframe_fileUpload_IPv4Import"></iframe>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        var fileName1 = "";
        var iframe1 = document.getElementById("iframe_fileUpload_IPv4Import");
        if (iframe1 != null) {
            fileName1 = iframe1.contentWindow.fun_GetFileName();
        }
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/IPv4ImportOK.do",
            processData: true,
            dataType: "json",
