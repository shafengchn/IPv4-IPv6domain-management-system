...
<div region="center">
<form id="ff" action="/GLPT/DM/IPv4GroupEditOK.do" method="post">
    <input type="hidden" id="Id" name="Id" value="${iPv4Group.id}"/>
    <input type="hidden" id="SortCode" name="SortCode" value="${iPv4Group.sortCode}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>分组代码[<font face="宋体" style="color: red;">*</font>]：</th>
            <td><input name="GroupCode" type="text" id="GroupCode" maxlength="50" class="txt" style="width: 220px" value="${iPv4Group.groupCode}"/></td>
        </tr>
        <tr>
            <th>分组名称[<font face="宋体" style="color: red;">*</font>]：</th>
            <td><input name="GroupName" type="text" id="GroupName" maxlength="50" class="txt" style="width: 220px" value="${iPv4Group.groupName}"/></td>
        </tr>
        <tr>
            <th>备注：</th>
            <td>
                <textarea id="Remarks" class="txtArea" style="width: 220px" rows="6" type="text" maxlength="200"
                          name="Remarks">${iPv4Group.remarks}</textarea>
            </td>
        </tr>
    </table>
</form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/IPv4GroupEditOK.do",
            processData: true,
            dataType: "json",
            data: formData,
