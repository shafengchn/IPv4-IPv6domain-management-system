...
<div region="center">
<form id="ff" action="/GLPT/DM/IPv4EditOK.do" method="post">
    <input type="hidden" id="Id" name="Id" value="${iPv4.id}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>IPv4地址[<font face="宋体" color="red">*</font>]：</th>
            <td>
                <input name="Address" type="text" id="Address" maxlength="50" class="txt"
                       style="width: 220px" value="${iPv4.address}"/>
            </td>
        </tr>
        <tr>
            <th>排序号[<font face="宋体" color="red">*</font>]：</th>
            <td><input name="SortCode" type="text" id="SortCode" class="easyui-numberbox" min="0" style="width: 220px" value="${iPv4.sortCode}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea id="Remarks" class="txtArea" style="width: 220px" rows="6" type="text" maxlength="200"
                          name="Remarks">${iPv4.remarks}</textarea>
            </td>
        </tr>
    </table>
</form>
...
<script type="text/javascript">
    $(function(){
        $("#Enabled").attr("checked",${iPv4.enabled});
    });
