...
<html>
<head>
    <title>域名管理-域名停用</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body class="easyui-layout">
<div region="center">
<form id="ff" action="/GLPT/DM/DomainNameDisableOK.do" method="post">
    <input type="hidden" id="Id" name="Id" value="${Id}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>停用理由[<font style="color:red;">*</font>]：</th>
            <td>
                <textarea id="DisableContent" class="txtArea" style="width: 220px" rows="6" type="text" maxlength="200"
                          name="DisableContent"></textarea>
            </td>
        </tr>
    </table>
</form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/DM/DomainNameDisableOK.do",
            processData: true,
            dataType: "json",
            data: formData,
