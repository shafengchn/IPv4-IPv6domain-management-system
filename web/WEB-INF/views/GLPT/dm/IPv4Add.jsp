...
<div region="center">
<form id="ff" action="/GLPT/DM/IPv4AddOK.do" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>IPv4地址[<font face="宋体" color="red">*</font>]：</th>
            <td>
                <input name="BeginAddress" type="text" id="BeginAddress" maxlength="50" class="txt"
                       style="width: 100px"/>
                <label>-</label>
                <input name="EndAddress" type="text" id="EndAddress" maxlength="50" class="txt" style="width: 100px"/>
