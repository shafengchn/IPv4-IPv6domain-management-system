...
<html>
<head>
    <title>学生借用者管理-导入</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body class="easyui-layout">
<div region="center">
    <form id="ff" action="/GLPT/BASE/StudentBorrowerImportOK.do" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                <td>学生借用者资料模板：</td>
                <td style="text-align: left;">
                    <a class="l-btn" href="/COMMON/DownloadDataTemplate.do?fileCode=StudentBorrowerImport&filePath=DataTemplate"
                       target="_blank">
        <span class="l-btn-left">
            ...
            <tr>
                <td colspan="2">
                    <iframe id="iframe_fileUpload_StudentBorrowerImport" width="100%" height="120px"
                            frameborder="0" src="/COMMON/fileUploadEx.do?filePath=other" scrolling="no"
                            name="iframe_fileUpload_StudentBorrowerImport"></iframe>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        var fileName1 = "";
        var iframe1 = document.getElementById("iframe_fileUpload_StudentBorrowerImport");
        if (iframe1 != null) {
            fileName1 = iframe1.contentWindow.fun_GetFileName();
        }
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/StudentBorrowerImportOK.do",
            processData: true,
            dataType: "json",
