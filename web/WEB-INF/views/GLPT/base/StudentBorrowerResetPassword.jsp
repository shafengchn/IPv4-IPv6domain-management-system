...
<html>
<head>
    <title>学生借用者管理-重置查询密码</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body>
<form id="ff" action="/GLPT/BASE/StudentBorrowerResetPasswordOK.do" method="post">
    <input type="hidden" id="StudentBorrowerId" name="StudentBorrowerId" value="${StudentBorrowerId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>新密码[<font face="宋体" style="color: red;">*</font>]：</th>
            <td><input name="NewPassword" type="password" id="NewPassword" maxlength="50" class="txt" style="width: 180px"/></td>
        </tr>
        <tr>
            <th>确认新密码[<font face="宋体" style="color: red;">*</font>]：</th>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/StudentBorrowerResetPasswordOK.do",
            processData: true,
            dataType: "json",
            data: formData,
