...
<html>
<head>
    <title>借用者管理-修改查询密码</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body>
<form id="ff" action="/GLPT/BASE/BorrowerEditPasswordOK.do" method="post">
    <input type="hidden" id="UserId" name="UserId" value="${UserId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>旧密码[<font face="宋体" style="color: red;">*</font>]：</th>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/BorrowerEditPasswordOK.do",
            processData: true,
            dataType: "json",
            data: formData,
