...
<html>
<head>
    <title>借用者管理-重置查询密码</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body>
<form id="ff" action="/GLPT/BASE/BorrowerResetPasswordOK.do" method="post">
    <input type="hidden" id="BorrowerId" name="BorrowerId" value="${BorrowerId}"/>
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/BorrowerResetPasswordOK.do",
            processData: true,
            dataType: "json",
            data: formData,
