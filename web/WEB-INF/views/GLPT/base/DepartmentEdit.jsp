...
<body>
<form id="ff" action="/GLPT/BASE/DepartmentEditOK.do" method="post">
    <input type="hidden" id="DepartmentId" name="DepartmentId" value="${department.departmentId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>编号[<font face="宋体">*</font>]：</th>
            <td><input name="Code" type="text" id="Code" maxlength="50" class="txt" style="width: 220px" value="${department.code}"/></td>
        </tr>
        <tr>
            ...
            <td>  <input class="easyui-combobox"
                         ...
                         valueField="Code"
                         textField="FullName"
                         panelHeight="auto" maxlength="50" style="width: 220px" value="${department.BMLXCode}"/></td>
        </tr>
        <tr>
            <th>部门名称[<font face="宋体">*</font>]：</th>
            <td><input name="FullName" type="text" id="FullName" maxlength="50" class="txt" style="width: 220px" value="${department.fullName}"/></td>
        </tr>
        <tr>
            <th>排序[<font face="宋体">*</font>]：</th>
            <td><input name="SortCode" type="text" id="SortCode" class="easyui-numberbox" min="0" style="width: 220px" value="${department.sortCode}"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $(function(){
        $("#Enabled").attr("checked",${department.enabled});
    });
    ...
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/DepartmentEditOK.do",
            processData: true,
            dataType: "json",
            data: formData,
