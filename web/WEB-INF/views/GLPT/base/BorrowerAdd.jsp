...
<div region="center">
    <div id="tt" class="easyui-tabs" fit="true">
        <div title="基本资料" style="padding:20px;">
            <form id="ff" action="/GLPT/BASE/BorrowerAddOK.do" method="post">
        ...
        <div title="个人相片" style="overflow:auto;padding:20px;">
            <fieldset>
                ...
                <iframe id="iframe_fileUpload_BorrowerPhotoImg" width="100%" height="300px"
                        frameborder="0" src="/COMMON/fileUploadImgEx.do?filePath=PhotoImg" scrolling="no"
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/BASE/BorrowerAddOK.do",
            processData: true,
            dataType: "json",
            data: formData,
