...
<html>
<head>
    <title>数据字典类别-修改</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body>
<form id="ff" action="/GLPT/CORE/ItemsEditOK.do" method="post">
    <input type="hidden" id="ItemsId" name="ItemsId" value="${items.itemsId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>编号[<font face="宋体">*</font>]：</th>
            <td><input name="Code" type="text" id="Code" maxlength="50" class="txt" style="width: 220px" value="${items.code}"/></td>
        </tr>
        <tr>
            <th>名称[<font face="宋体">*</font>]：</th>
            <td><input name="FullName" type="text" id="FullName" maxlength="50" class="txt" style="width: 220px" value="${items.fullName}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name="SortCode" type="text" id="SortCode" maxlength="50" class="txt" style="width: 220px" value="${items.sortCode}"/></td>
        </tr>
    </table>
    <div class="frmbottom">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#Enabled").attr("checked",${items.enabled});
    });
