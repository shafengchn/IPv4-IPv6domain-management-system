...
<html>
<head>
    <title>数据字典明细-修改</title>
    <jsp:include page="/Common/PageCss.jsp"></jsp:include>
    <jsp:include page="/Common/PageJs.jsp"></jsp:include>
</head>
<body>
<form id="ff" action="/GLPT/CORE/ItemDetailsEditOK.do" method="post">
    <input type="hidden" id="ItemDetailsId" name="ItemDetailsId" value="${itemDetails.itemDetailsId}">
    <input type="hidden" id="ItemsId" name="ItemsId" value="${itemDetails.itemsId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>编号[<font face="宋体">*</font>]：</th>
            <td><input name="Code" type="text" id="Code" maxlength="50" class="txt" style="width: 220px" value="${itemDetails.code}"/></td>
        </tr>
        <tr>
            <th>名称[<font face="宋体">*</font>]：</th>
            <td><input name="FullName" type="text" id="FullName" maxlength="50" class="txt" style="width: 220px" value="${itemDetails.fullName}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name="SortCode" type="text" id="SortCode" maxlength="50" class="txt" style="width: 220px" value="${itemDetails.sortCode}"/></td>
        </tr>
        <tr>
            <th>说明：</th>
            <td colspan="3">
                <textarea id="Description" class="txtArea" style="width: 220px" rows="6" type="text" maxlength="200"
                          name="Description">${itemDetails.description}</textarea>
            </td>
        </tr>
    </table>
    <div class="frmbottom">
...
<script type="text/javascript">
    $(function(){
        $("#Enabled").attr("checked",${itemDetails.enabled});
    });
    ...
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/CORE/ItemDetailsEditOK.do",
            processData: true,
            dataType: "json",
            data: formData,
