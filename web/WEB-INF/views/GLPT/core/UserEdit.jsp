...
<body>
<form id="ff" action="/GLPT/CORE/UserEditOK.do" method="post">
    <input type="hidden" id="UserId" name="UserId" value="${user.userId}"/>
    <input type="hidden" id="SortCode" name="SortCode" value="${user.sortCode}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        ...
        <tr>
            ...
            <td colspan="3"><input name="RealName" type="text" id="RealName" maxlength="50" class="txt" style="width: 180px"
        ...
        <tr>
            ...
            <th>手机：</th>
            <td><input name="Mobile" type="text" id="Mobile" maxlength="50" class="txt" style="width: 180px"
                       value="${user.mobile}"/></td>
        </tr>
        <tr>
            <th>出生日期：</th>
            <td><input name="Birthday" type="text" id="Birthday" style="width: 180px" class="easyui-datebox"
        ...
        <tr>
            <th>QQ号码：</th>
            <td><input name="OICQ" type="text" id="OICQ" maxlength="50" class="txt" style="width: 180px"
                       value="${user.OICQ}"/></td>
            <th>电子邮件：</th>
            <td><input name="Email" type="text" id="Email" maxlength="50" class="txt" style="width: 180px"
                       value="${user.email}"/></td>
        </tr>
        <tr>
            ...
            <td>
                <input class="easyui-combobox"
                       ...
                       valueField="Code"
                       textField="FullName" maxlength="50" style="width: 180px" value="${user.departmentCode}"/>
            </td>
            <th>默认职务：</th>
            <td>
                <input class="easyui-combobox"
                       ...
                       valueField="Code"
                       textField="FullName" maxlength="50" style="width: 180px" value="${user.titleCode}"/>
            </td>
        </tr>
        <tr>
