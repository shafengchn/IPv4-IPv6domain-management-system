...
<body>
<form id="ff" action="/GLPT/CORE/UserEditPasswordOK.do" method="post">
    <input type="hidden" id="UserId" name="UserId" value="${UserId}"/>
    <table border="0" cellpadding="0" cellspacing="0" class="frm">
        <tr>
            <th>旧密码[<font face="宋体">*</font>]：</th>
            <td><input name="OldPassword" type="password" id="OldPassword" maxlength="50" class="txt" style="width: 220px"/></td>
        </tr>
        <tr>
            <th>新密码[<font face="宋体">*</font>]：</th>
            <td><input name="NewPassword" type="password" id="NewPassword" maxlength="50" class="txt" style="width: 220px"/></td>
        </tr>
        <tr>
            <th>确认新密码[<font face="宋体">*</font>]：</th>
            <td><input name="ConfirmNewPassword" type="password" id="ConfirmNewPassword" maxlength="50" class="txt" style="width: 220px"/></td>
        </tr>
    </table>
    <div class="frmbottom">
...
<script type="text/javascript">
    var fun_submit = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/GLPT/CORE/UserEditPasswordOK.do",
            processData: true,
            dataType: "json",
            data: formData,
