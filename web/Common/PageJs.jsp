...
<script type="text/javascript" src="<%=basePath%>js/Validator/JValidator.js"></script>
<script type="text/javascript" src="<%=basePath%>js/artDialog/artDialog.source.js"></script>
<script type="text/javascript" src="<%=basePath%>js/artDialog/iframeTools.source.js"></script>
