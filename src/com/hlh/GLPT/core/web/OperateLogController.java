...
public class OperateLogController {
   @Autowired
    ...
    public ModelAndView list(HttpServletRequest req) {
        ...
        mav.setViewName("GLPT/core/OperateLogList");
        return mav;
    }

    @RequestMapping(value = "OperateLogFindPage")
    @ResponseBody
    public String findPage(HttpServletRequest req) throws Exception {
        ...
        return "{\"total\":" + operateLogService.GetRowCount(findValue1) + ",\"rows\":" + operateLogService.findByPage(findValue1, start, number) + "}";
    }
